...
def SkrlVecEnvWrapper(
    env: ManagerBasedRLEnv, ml_framework: Literal["torch", "jax", "jax-numpy"] = "torch", obs_type=None
):
    ...
    if ml_framework.startswith("torch"):
        ...
        from skrl_testing.utils.skrl import wrap_env
    elif ml_framework.startswith("jax"):
    ...
    return wrap_env(env, wrapper="isaaclab", obs_type=obs_type)
